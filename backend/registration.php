  ...
  <div class="hero-content flex-col lg:flex-row-reverse">
    <div class="text-center lg:text-left">
      ...
      <p class="py-6">Please enter your credentials to create an account.
        Already have an account? <a class="link link-info" href="login.php">Login</a></p>
    </div>
    <div class="card shrink-0 w-full max-w-md shadow-2xl bg-base-100">
      <form class="card-body" method="POST" action="registration_post.php">
        <div class="form-control">
          <label class="label">
            <span class="label-text">Conference ID</span>
          </label>
          <input name="student_id" type="text" placeholder="Conference ID" class="input input-bordered" value="<?= (isset($_SESSION['old_student_id'])) ? $_SESSION['old_student_id'] : '' ?>" />
