  ...
  <div class="hero-content flex-col lg:flex-row-reverse">
    <div class="text-center lg:text-left">
      ...
      <p class="py-6">Please sign-in to your account and continue to the dashboard.
        Don't have an account? <a class="link link-info" href="registration.php">Registration</a></p>
    </div>
    <div class="card shrink-0 w-full max-w-sm shadow-2xl bg-base-100">
      ...
      ?>
      <form class="card-body" method="POST" action="login_post.php">
        <div class="form-control">
          <label class="label">
            <span class="label-text">Conference ID</span>
          </label>
          <input name="student_id" type="text" placeholder="Conference ID" class="input input-bordered" required />
        </div>
        <div class="form-control">
          <label class="label">
