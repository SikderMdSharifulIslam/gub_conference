...
if(in_array($extension, $allowed_extension))
{
    ...
    {      
        $insert = "INSERT INTO committees (guest_title, details) VALUES ('$title', '$sub_title')";
        ...
        $update_image = "UPDATE committees SET img='$file_name' WHERE id=$banner_id";
        $update_image_result = mysqli_query($db_connect, $update_image);
        $_SESSION['success'] = "Committee Added!";
